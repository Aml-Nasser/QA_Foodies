<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="Foodies_WebApp.AddUser" %>
                       ...
                       <asp:CompareValidator id="comparePasswords" runat="server" ControlToCompare="pass1" ControlToValidate="pass22" ErrorMessage="Passwords do not match"
                           Display="Dynamic" ForeColor="Red"></asp:CompareValidator>
                            ...
                            <div class="form-group pt-1">
                                <asp:Button id="AddUserBtn" class="btn btn-primary btn-block" runat="server" Text="Add" BorderStyle="Solid" ToolTip="Submit" OnClick="AddUserBtn_Click"/>  
