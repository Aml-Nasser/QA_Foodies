            ...
            <div class="row">
                <div class="col-md-5 mx-auto">
                    <div class="card card-body" style="    background-color: #cad2c5;">
                        <div>
                            <center><h4>Offers and Pormotions</h4></center>
                            <hr>
                        </div>
                        <form id="submitForm" action="#login" method="post" data-parsley-validate=""
                            ...
                            <div class="form-group required">
							    <div id="yud">
                                <asp:LSabel id="yp" for="username">Your Points </asp:LSabel>
							...
							<div class="form-group pt-1">
                                <asp:Button class="btn btn-primary btn-block" type="submit">Use my loyality point</asp:Button>
                            </div>
